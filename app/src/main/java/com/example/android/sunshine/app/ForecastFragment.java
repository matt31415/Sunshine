...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... postcodes) {
            //Note that we're using String for postcodes here.  This allows us to include leading zeros
            ...
            String[] forecasts;
            try {
                //Convert the forecast JSON into JSON strings
                forecasts = getWeatherDataFromJson(forecastJsonStr,numForecastDays);
                return forecasts;
            }
            catch (JSONException e) {
                Log.e(LOG_TAG, "Error converting forecast data from JSON", e);
                return null;
            }
        }
