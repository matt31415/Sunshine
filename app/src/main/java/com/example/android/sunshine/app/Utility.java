...
public class Utility {
    ...
    /**
     * Converts db wind speed and direction into the format "Wind: speed direction
     * @param context Context to use for resource localization
     * @param windSpeed Wind speed from the database (in km/hr)
     * @param degrees Wind direction from database (in degrees)
     * @return The wind speed and direction in a strong formatted like "Wind: 20 mph NE"
     */
